...
function Cart() {
    ...
    return (
        <div className='bg-half-transparent w-full fixed nav-item top-0 right-0'>
            <div className="float-right h-screen duration-1000 ease-in-out dark:text-gray-200 transition-all p-8 dark:bg-[#484B52] bg-white md:w-400">
                        ...
                        <div>
                            ...
                            <div className='flex gap-4 mt-2 items-center'>
                                ...
                                <div className='flex items-center border-1 border-r-0 border-color rounded'>
                                    ...
                                    <p className='p-2 border-r-1 dark:border-gray-600 border-color text-gray-600 dark:text-white'>0</p>
