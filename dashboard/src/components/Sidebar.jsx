            ...
            <>
                <div className='flex justify-between items-center'>
                    ...
                    <TooltipComponent content='Menu' position='BottomCenter'>
                        <button type='button' style={{color: currentColor}} onClick={() => setActiveMenu((prevActiveMenu) => !prevActiveMenu)}  className='text-xl rounded-full p-3 hover:bg-light-gray mt-4 block'>
                            <MdOutlineCancel/>
                        </button>
                    </TooltipComponent>
                </div>
                ...
                {links.map((item) => (
                    <div key={item.title}>
                        <p className='uppercase m=3 mt-4 text-gray-400 dark:text-grey-400'>
                            {item.title}
                        </p>
                        {item.links.map((link) => (
