...
import {LineChart, Pie, SparkLine, Stacked, Button} from '../components'
    ...
    return (
        <div className='mt-24'>
            <div className='flex flex-wrap lg:flex-nowrap justify-center'>
                ...
                <div className='flex m-3 flex-wrap gap-1 justify-center items-start'>
                        ...
                        <div className='border-r-1 border-color m-4 pr-10'>
                            <div>
                                <p>
                                    ...
                                    <span className='p-1.5 hover:drop-shadow-xl cursor-pointer rounded-full bg-green-400 text-xs ml-3 text-white'>23%</span>
                                </p>
                                <p className='text-gray-500 mt-1'>Budget</p>
                            </div>
                            <div>
                                <p className='font-semibold text-3xl'>$48,487</p>
